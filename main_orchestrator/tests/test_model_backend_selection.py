...
def test_create_memory_agent_uses_model_name_from_env(monkeypatch):
    captured = {}
...
def test_memory_agent_model_falls_back_to_config_when_env_missing(monkeypatch):
    ...
    assert memory_supervisor_module.config.get_llm_model() == memory_supervisor_module.config.LLM_MODEL
