...
class MedicalEntity(BaseModel):
    ...
    # Standardization fields (filled by standardization step)
    standard_code: Optional[str] = Field(None, description="标准编码（ICD-10、ATC、LOINC、SNOMED-CT等）")
    standard_system: Optional[str] = Field(None, description="编码系统名称")
    normalized_value: Optional[float] = Field(None, description="标准化后的数值")
    normalized_unit: Optional[str] = Field(None, description="标准化后的单位")
