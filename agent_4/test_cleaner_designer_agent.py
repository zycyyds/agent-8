...
def test_step4_env_overrides_yaml(monkeypatch):
    monkeypatch.setenv("STEP4_MODEL_BACKEND", "ollama")
    monkeypatch.setenv("STEP4_OLLAMA_MODEL", "env-ollama")
    monkeypatch.setenv("STEP4_OLLAMA_TEMPERATURE", "0.6")
    monkeypatch.setenv("STEP4_OLLAMA_SEED", "999")
...
def test_generic_model_name_does_not_override_step4(monkeypatch):
    monkeypatch.delenv("STEP4_MODEL_BACKEND", raising=False)
    monkeypatch.delenv("STEP4_OLLAMA_MODEL", raising=False)
    monkeypatch.delenv("OLLAMA_MODEL_NAME", raising=False)
